...
Write-Host "📋 Step 4: Skipping mutation testing (runs on GitHub)..." -ForegroundColor Yellow
Write-Host "💡 Mutation testing will run automatically on GitHub when you push to main" -ForegroundColor Cyan
